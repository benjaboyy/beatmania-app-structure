    ...
    <div class="container">
      <div class="row d-flex">
        <div class="col-12 col-md-5 mx-auto">
          ...
          <router-link to="/submitArcade" class="btn w-100 btn-light me-2 mb-2 disabled" href="#" type="button" role="button"><i class="fas fa-cogs"></i> Update Arcades</router-link>
          <router-link to="/ranking" class="btn w-100 btn-theme-3 me-2 mb-2 disabled" href="#" type="button" role="button"><i class="fas fa-trophy"></i> Arcade Ranking</router-link>
