<template>
  <div class="stats-screen px-2 px-md-5 m-auto">
    <h1 class="text-center my-4">Arcade [ARCADE.NAME]</h1>
    <div class="card">
      <div class="card-body">
        <h3>Arcade [ARCADE.NAME]</h3>
      ...
      <ul>
        ...
        <div class="mb-2">
          <button class="btn btn-outline-primary me-2"><i class="fa fa-mobile-alt me-2"></i> Add to homescreen</button>
